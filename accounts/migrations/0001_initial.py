    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preferred_workout_type', models.CharField(blank=True, max_length=50, null=True)),
                ('workout_frequency', models.IntegerField(blank=True, help_text='Days per week', null=True)),
